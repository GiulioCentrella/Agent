...
struct _REGSHOT {
    ...
    LPKEYCONTENT  lpHKCC;                   // Pointer to Shot's HKCC registry keys
    LPKEYCONTENT  lpHKCR;                   // Pointer to Shot's HKCR registry keys
    LPKEYCONTENT  lpHKCU;                   // Pointer to Shot's HKCU registry keys
...
struct _FILEHEADER {
    ...
    DWORD ofsHKCC;
    DWORD ofsHKCR;      // ofs 16 len 4
    DWORD ofsHKCU;      // ofs 16 len 4
