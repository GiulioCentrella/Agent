...
/*
    Copyright
*/
#define REGSHOT_VERSION_COPYRIGHT   TEXT("Copyright (C) 1999-2015, Regshot Team and all contributors")


/*
    URL
*/
#define REGSHOT_URL   TEXT("http://sourceforge.net/projects/regshot/")
...
#       define REGSHOT_PATH			TEXT("Reg_Shot")
#       if defined(_UNICODE)
#           if defined(_DEBUG)
